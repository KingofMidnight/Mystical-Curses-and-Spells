...
public class Curse {
    ...
    public static final Supplier<IForgeRegistry<Curse>> REGISTRY =
        CURSE.makeRegistry(RegistryBuilder::new);

    public static final RegistryObject<Curse> LIFEBANE =
        CURSE.register("lifebane", () -> new Lifebane());
